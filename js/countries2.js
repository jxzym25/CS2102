...
function print_country(country_id, name){
	...
	for(x in country_arr){
		...
		if(country_arr[x] == name)
			option_str.options[i].setAttribute("selected","selected");
		i++;
	}
}

function print_state(state_id, country, name){
